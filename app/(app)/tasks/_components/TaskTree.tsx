...
const NODE_STYLE = { bg: "var(--surface)", border: "var(--border-strong)", text: "var(--foreground)" };
    ...
    >
      ...
      {editing ? (
        <input
          ...
          className="nodrag w-full rounded border border-border bg-input px-1 py-0.5 text-sm text-foreground outline-none"
        />
      ) : (
