...
// filled=false: обводка с нейтральной заливкой-подложкой (--heart-empty:
// белая в светлой теме, тёмная в тёмной). filled=true: сплошная заливка
// текущим цветом (currentColor) — используем с text-danger для лайка.
  ...
  return (
    <svg viewBox="0 0 24 24" className={className}>
      <path
        ...
        fill={filled ? "currentColor" : "var(--heart-empty)"}
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinejoin="round"
      />
...
export function IconUsers({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className}>
      ...
      <path d="M3.5 19c0-3 2.5-5.2 5.5-5.2s5.5 2.2 5.5 5.2" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" />
      <path d="M15.5 6.3a3 3 0 0 1 0 5.9M18.2 13.8c2 .6 3.3 2.4 3.3 4.8" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" />
    </svg>
  );
}
